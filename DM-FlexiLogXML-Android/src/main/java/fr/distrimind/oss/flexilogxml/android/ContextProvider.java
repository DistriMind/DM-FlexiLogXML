...
public class ContextProvider {
	...
	public static Context getApplicationContext()
	{
		...
		if (r==null) {
			application = null;
			FlexiLogXML.log(Level.ERROR, () -> "Error : context was not defined. Please affect context by calling method fr.distrimind.oss.flexilogxml.android.ContextProvider.initialize(Application) according to Android Application instance");
			throw new RuntimeException();
		}
		return r;
	}
